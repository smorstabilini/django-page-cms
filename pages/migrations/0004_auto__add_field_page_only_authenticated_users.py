...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.only_authenticated_users'
        db.add_column('pages_page', 'only_authenticated_users', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.only_authenticated_users'
        db.delete_column('pages_page', 'only_authenticated_users')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'only_authenticated_users': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['pages.Page']"}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'accessible_pages'", 'null': 'True', 'to': "orm['auth.Permission']"}),
