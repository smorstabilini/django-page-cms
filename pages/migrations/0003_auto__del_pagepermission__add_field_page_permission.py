...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.permission'
        db.add_column('pages_page', 'permission', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accessible_pages', null=True, to=orm['auth.Permission']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Page.permission'
        db.delete_column('pages_page', 'permission_id')
